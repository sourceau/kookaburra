...
function init() {
 ...
 // renderer.setSize(window.innerWidth, window.innerHeight);
  ...
  canvas.style.cssText = "background-image: url(https://cdn.shopify.com/s/files/1/0609/4261/4737/files/trans-bg-3.png?v=1641601267); background-size: 25px;";
  document.body.appendChild(renderer.domElement);
  renderer.domElement.id = "RendaCanvas";
  container = document.getElementById("RendaCanvas");
...
function fadeElementOut(element) {
    ...
    }, 500); // Adjust timeout to match transition duration in milliseconds
}
